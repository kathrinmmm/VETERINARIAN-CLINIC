...
public class PetService {
    ...
    public PetService() {
        ...
        speciesToBreeds.put("Câine", List.of("Labrador", "Beagle", "Bulldog", "Golden Retriever", "Cocker Spaniol"));
        speciesToBreeds.put("Pisică", List.of("Siamese", "Persană", "Maine Coon", "Bengaleză", "Sfinx"));
